const testData = {
	...
	auth: {
		message:
			"Hello organization 'BxvqsKQBEeKGMeAsN09ScrVt' hitting Onfleet from 104.248.209.194",
		status: 200,
	},
	list: [
		{
	...
	get: {
		...
		destination: {
			...
			location: [-121.79274459999999, 37.7020352],
			address: {
				apartment: "",
				state: "California",
				postalCode: "94103",
	...
	updateWorkers: {
		...
		phone: "+18883033030",
		activeTask: null,
		tasks: ["ybB97MGXhGoAAKrUAlyywmBN"],
		onDuty: false,
	...
	getRoutePlans: [
		{
			...
			timeLastModified: 1700000002000,
		},
	],
	createRoutePlanProps: {
		name: "Morning Route",
		startTime: 1700000000000,
		taskIds: ["T1", "T2"],
		timezone: "America/New_York",
	...
	createRoutePlan: {
		...
		actualEndTime: null,
		shortId: "def456",
		timeCreated: 1700000003000,
		timeLastModified: 1700000003000,
	},
	scheduleOptimizationProps: {
		tasks: ["T3", "T4"],
		teams: { "TEAM1": ["W1", "W2"] },
		date: 1710000000000,
		timezone: "America/New_York",
